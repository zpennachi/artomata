...
<div class="ui" id="controls">
    <!-- Particle Rules -->
    <div><label>Green affects:</label>
        <select id="green-red" class="select-control">
            <option value="-0.01">Repel Red</option>
            <option value="0.01">Attract Red</option>
        </select>
        <select id="green-blue" class="select-control">
            <option value="0.01">Attract Blue</option>
            <option value="-0.01">Repel Blue</option>
        </select>
        <select id="green-yellow" class="select-control">
            <option value="0.01">Attract Yellow</option>
            <option value="-0.01">Repel Yellow</option>
        </select>
    </div>
    <div><label>Red affects:</label>
        <select id="red-green" class="select-control">
            <option value="-0.01">Repel Green</option>
            <option value="0.01">Attract Green</option>
        </select>
        <select id="red-blue" class="select-control">
            <option value="0.01">Attract Blue</option>
            <option value="-0.01">Repel Blue</option>
        </select>
        <select id="red-yellow" class="select-control">
            <option value="0.01">Attract Yellow</option>
            <option value="-0.01">Repel Yellow</option>
        </select>
    </div>
    <div><label>Blue affects:</label>
        <select id="blue-green" class="select-control">
            <option value="-0.01">Repel Green</option>
            <option value="0.01">Attract Green</option>
        </select>
        <select id="blue-red" class="select-control">
            <option value="-0.01">Repel Red</option>
            <option value="0.01">Attract Red</option>
        </select>
        <select id="blue-yellow" class="select-control">
            <option value="0.01">Attract Yellow</option>
            <option value="-0.01">Repel Yellow</option>
        </select>
    </div>
    <div><label>Yellow affects:</label>
        <select id="yellow-green" class="select-control">
            <option value="-0.01">Repel Green</option>
            <option value="0.01">Attract Green</option>
        </select>
        <select id="yellow-red" class="select-control">
            <option value="-0.01">Repel Red</option>
            <option value="0.01">Attract Red</option>
        </select>
        <select id="yellow-blue" class="select-control">
            <option value="-0.01">Repel Blue</option>
            <option value="0.01">Attract Blue</option>
        </select>
    </div>
    <!-- Settings Sliders -->
    <div><label>Falloff Radius:</label><input type="range" id="falloffRadius" min="5" max="30" value="0"></div>
    <div><label>Gravity Strength:</label><input type="range" id="gravityStrength" min="0" max="0.95" step="0.001" value="0"></div>
    <div><label>Velocity Damping:</label><input type="range" id="velocityDamping" min="0.0" max="0.99" step="0.01" value="0"></div>
</div>


 <script src="https://unpkg.com/three@0.128.0/build/three.min.js"></script>
<script src="https://unpkg.com/three@0.128.0/examples/jsm/webxr/ARButton.js"></script>
